function [data_struct] = IOS_import_wrapper(varargin)
...
%% Select files to import
    ...
    file_info = import.get_filenames(save_path, experiment_log_filename);   % get file names that need to be imported
...
%     params.Block_Length = params.Block_Length*2;        % fix block length
    params.fs = mean(1./deriv(frame_timing));           % calculate sampling frequency
...
%% Output
    ...
    data_struct.ttl_timing.frame_timing = frame_timing;
