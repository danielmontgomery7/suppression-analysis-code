...
function [data_struct] = IOS_analyze_wrapper(varargin)
    ...
    % 2) parameters: structure with the following possible fields:
        % .F0 (How F0 is calculated: 'ibi', 'grey', 'median', 'avg', 'min')
...
%% Call functions
    ...
    [traces_dFF, average_dFF_table, average_dFF] = analyze.calculate_dFF(data_struct, separated_traces, F0);
...
%     data_struct.traces.F0_all = F0_all;
    ...
    data_struct.average_dFF_table = average_dFF_table;
